...
class ProfileTestClass(TestCase):
    def setUp(self):
        ...
        self.profile = Profile(user= self.ryan, profile_pic='mepng',bio='bio', location='Nairobi, Kenya', email='ryan@gmail', link='www.profile.com')
        self.ryan.save()
...
class VoteTestClass(TestCase):
    ...
    def test_get_project_voters(self):
        ...
        self.assertEqual(voters[0].voter.user.username, 'ryan')
